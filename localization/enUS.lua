...
L["Use a global profile if you want the same look on every character, or use character-specific profiles for a different look on every character."] = "Use a global profile if you want the same look on every character, or use character-specific profiles for a different look on every character."
