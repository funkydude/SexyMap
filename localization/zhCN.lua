...
local _, sm = ...
local L = sm.L
L.dayNightButton = "昼/夜指示器"
L.classicLFGButton = "经典 寻求组队 按钮（可用时）"
L.classicPVPButton = "经典 PvP 按钮（可用时）"
L.omniumFolioButton = "万奥宝典（可用时）"
L["1. Background"] = "1、背景"
L["2. Border"] = "2、边框"
L["3. Artwork"] = "3、装饰"
L["4. Overlay"] = "4、覆盖"
...
-- Buttons.lua
L.addonCompartment = "插件间隔"
L.craftingOrder = "制造订单（可用时）"

-- Coordinates.lua
L.updateRate = "更新频率（秒）"
L.updateRateDesc = "数值越小，坐标更新越频繁，但会因频繁获取游戏数据而占用更多内存和CPU资源。"
L.Precision = "精确度"

-- Movers.lua
L.moversDescription = "启用移动特定界面元素的功能。"
L.disableWarning = "禁用此选项将暂时重新加载界面。是否确定？"
L.enableObject = "启用 %s"
L.lockObject = "锁定 %s"
L.pvpCaptureBar = "PvP 占领进度条"
L.buffs = "增益/减益"
L.topCenterObjectivesWidget = "顶部中心目标/PvP追踪器控件"
L.zoneTextCombatClick = "|cFF33FF99SexyMap|r: 要在战斗中切换世界地图，必须在「区域文本」选项中启用此功能。"
L.zoneTextSecureButtonEnable = "允许战斗中点击"
L.zoneTextSecureButtonEnableDesc = "通常可通过点击区域文本来切换世界地图，但在战斗中需启用此功能才能使用。\n\n|cffff0000警告！|r 除非明确了解后果，否则请勿启用。开启后，战斗中所有插件将无法修改小地图（如移动或隐藏）。"
L.none = "无"
L.thin = "细"
L.thick = "粗"
L.outline = "轮廓"
